...
//  Animations
//
//  Created by Administrator on 27/03/22.
//
...
class PRViewController: UIViewController {
    ...
    @objc func gestureAction(_ sender: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            AnimationSetting.isAnimation = point.y < 140
            
            if AnimationSetting.isAnimation { shapeLayer.removeAllAnimations() }
...
extension PRViewController: CAAnimationDelegate {
